...
import sys
sys.path.insert(0, '../')
from src.projects_summary import projects_summary
from src.util import HOME_PATH
import pandas as pd
from os.path import join


def test_projects_summary():
    bucket_path = join(HOME_PATH, 'test/test_file/test_buckets_summary.csv')
    project_path = join(HOME_PATH, 'test/test_file/test_projects_summary.csv')
